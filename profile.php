...
$(document).ready(function(){
    ...
    <?php
        ...
        {
    ?>
    $('#uploaded_image').html('<img src="<?php echo $row["user_profile"]; ?>" class="img-thumbnail" width="225" /><input type="hidden" name="hidden_user_profile" value="<?php echo $row["user_profile"]; ?>" />');
    <?php
        }
    }
    ?>
		...
		{		
			$.ajax({
				...
				success:function(data)
				{
                    ...
                    {
                        $('#uploaded_image').html('<img src="'+data.user_profile+'" class="img-thumbnail" width="525" /><input type="hidden" name="hidden_user_profile" value="'+data.user_profile+'" />');
