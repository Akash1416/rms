    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                ?>
                    <i class="dd" style="font-size: 40px;" > &#128104;&#8205;&#127859; </i>
                    <div class="sidebar-brand-text mx-3" style="font-size: 27px;" >RSS</div>
                <?php
                }
                ?>
            </a>
            ...
            <link rel="stylesheet" href="bot_logo.css" class="style">
            
            <div class="sidebar-bottom">
                <div class="chatbot-logo-container">
                    <a href="bot.php">
                        <img src="chatbot.png" alt="Chatbot" class="chatbot-logo">
                    </a>
                </div>
            </div>
